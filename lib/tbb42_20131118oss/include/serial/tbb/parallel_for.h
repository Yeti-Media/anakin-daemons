...
void parallel_for(const Range& range, const Body& body) {
	serial::interface6::start_for<Range, Body, const __TBB_DEFAULT_PARTITIONER >::run(
...
void parallel_for(const Range& range, const Body& body,
	...
	serial::interface6::start_for<Range, Body, const simple_partitioner>::run(
...
void parallel_for(const Range& range, const Body& body,
	...
	serial::interface6::start_for<Range, Body, const auto_partitioner>::run(
			range, body, partitioner);
}
...
void parallel_for(const Range& range, const Body& body,
	...
	serial::interface6::start_for<Range, Body, affinity_partitioner>::run(range,
			body, partitioner);
}
