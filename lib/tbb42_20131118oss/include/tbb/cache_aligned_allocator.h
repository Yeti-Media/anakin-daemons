...
/** @ingroup memory_allocation */
void* __TBB_EXPORTED_FUNC NFS_Allocate(size_t n_element, size_t element_size,
		void* hint);
...
public:
	...
	template<typename U> cache_aligned_allocator(
			const cache_aligned_allocator<U>&) throw () {
	}
	...
	pointer allocate(size_type n, const void* hint = 0) {
		...
		return pointer(
				internal::NFS_Allocate(n, sizeof(value_type),
