...
public:
	...
	blocked_range3d(PageValue page_begin, PageValue page_end,
			...
			ColValue col_end) :
			my_pages(page_begin, page_end), my_rows(row_begin, row_end), my_cols(
					col_begin, col_end) {
	}
	...
	blocked_range3d(PageValue page_begin, PageValue page_end,
			...
			my_pages(page_begin, page_end, page_grainsize), my_rows(row_begin,
					row_end, row_grainsize), my_cols(col_begin, col_end,
					col_grainsize) {
	}
